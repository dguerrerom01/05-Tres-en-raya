...
public class TresNRaya {
	...
	public boolean realizarJugada() {
		// Turno sirve para conocer a quien le correponde el turno de jugada y
		// asi colocar la ficha correcta
		// Si la jugada es la sexta debemos mover. la variable mover controla
		// que se haya metido la casilla origen
		if (numerojugada > 6) {
			if (!mover) {
	 ...
	 * 
	 * @param posicionActualX
	 * @param posicionActualY
	 */
	public void asignarPosicion(int posicionActualX, int posicionActualY) {
		destinox = posicionActualX;
		destinoy = posicionActualY;
	}
	...
	/**
	 * RecoGe el valor actual del estado de la jugada para poder dar un mensaje
	 * correcto
	 * 
	 * @param numero
	 */
	...
	/**
	 * Retorna si hay un problema con la casilla seleccionada
	 * 
	 * @return anommalia
	 */
	 ...
	 * cero seignifica que la casilla estalibre
	 * 
	 * @param coordenada
	 *            de fila
	 * @param coordenada
	...
	// Si el numero de jugada es par el turno es del jugador 2 y si no del
	// jugador 1
	/**
