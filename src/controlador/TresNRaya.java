...
public class TresNRaya {
	...
	/**
	 * Comprueba si la casilla origen esta ocupada por una ficha de la propiedad
	 * del turno actual
	 * 
	...
	/**
	 * Esta funcion retorna una "X" cuando se le pasa un 2 por parametro, una
	 * "O" cuando se le pasa un 1 y un espacio en blanco cuando se le pasa un
	 * cero
	 */
